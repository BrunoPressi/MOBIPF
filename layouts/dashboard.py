...
def create_dashboard():
    return html.Div([
        ...
        html.Div(dcc.Graph(id='ACIDENTES_GRAPH'), style=chart_container_style),
        html.Div(dcc.Graph(id='ACIDENTES_REGIAO_GRAPH'), style=chart_container_style),

        # Linha 2: Gráficos de detalhamento
        html.Div(dcc.Graph(id='ACIDENTES_TURNO_GRAPH'), style=chart_container_style),
        html.Div(dcc.Graph(id='ACIDENTES_TIPO_GRAPH'), style=chart_container_style),
        html.Div(dcc.Graph(id='ACIDENTES_VEICULO_GRAPH'), style=chart_container_style),

        # Linha 3: Gráfico de tendência ocupando toda a largura
        html.Div(
            html.Div(dcc.Graph(id='ACIDENTES_MES_GRAPH'), style=chart_container_style), 
